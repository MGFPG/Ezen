  ...
  <script type="text/javascript" lang="ko">
    ...
    //추가 폼 실행함수
    function addproduct(){
      window.open("store_write.jsp", "창고 추가", "width=500, height=800, top=150, left=200")
      }
  
    //수정 폼 실행함수
    function store_update(storeid){
      window.open("store_update.jsp?storeid="+storeid, "창고관리 수정", "width=500, height=800, top=150, left=200")
    }
