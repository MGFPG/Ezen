  ...
  <script type="text/javascript" lang="ko">
    ...
    //추가 폼 실행함수
    function addproduct(){
          window.open("PP_write.jsp", "공정계획관리 추가", "width=500, height=800, top=150, left=200")
      }
  
    //수정 폼 실행함수
    function PP_update(PPid){
      window.open("PP_update.jsp?PPid="+PPid, "재고관리 수정", "width=500, height=800, top=150, left=200")
    }
