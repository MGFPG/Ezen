  ...
  //추가 폼 실행함수
  function addproduct(){
		window.open("./product_add.jsp", "재고관리 추가", "width=500, height=800, top=150, left=200")
    }

  //수정 폼 실행함수
  function product_update(p_id){
    window.open("./product_update.jsp?p_id="+p_id, "재고관리 수정", "width=500, height=800, top=150, left=200")
  }
