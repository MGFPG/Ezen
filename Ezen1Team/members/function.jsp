  ...
  <script type="text/javascript" lang="ko">
    ...
    function memadd(){
      document.location.href="./member_register.jsp";
    }

    //회원 수정하는 페이지 부르는 함수
    function member_change(num){
      //alert(num);
      document.location.href="./member_update.jsp?num="+num;
    }
     ...
     function member_delete(num){
      //alert(num);
      document.location.href="./delete_action.jsp?num="+num;
    }
