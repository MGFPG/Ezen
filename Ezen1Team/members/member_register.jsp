...
-->
   ...
   <form method="post" action="./register_action.jsp" name ="New" enctype="multipart/form-data" onsubmit="return check();" >
 ...
 *아이디 : 
    <input type='text' size='50' name=id maxlength='100' width : 50px class='form-control' required="required" placeholder="영문, 숫자, 특수문자 무관" value=admin>
    <p class='help-block'></p>
 ...
 *등급선택
    <input type="radio" id="manager" name="grade" value="manager" >관리자
...
*주소 : 
   <input type='text' size='50' name=address maxlength='100'  class='form-control' placeholder="서울시 마포구 상암동">  
