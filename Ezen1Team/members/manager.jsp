...
<br>
<!--제목-->
<h2><b>[등록된 회원 리스트]</b></h2>
<input type="button" value="새로고침" width="40"
onClick="location='index.jps'"> 
...
<div class="container">
    ...
    <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">   
      ...
      <thead>
        ...
        <!--일자 옆에 수정, 삭제 버튼 추가 / num(primary키)으로 정보를 가져옴-->
        <button onclick="member_change('<%=id%>')" title="회원정보 수정하기">수정</button>
  ...
  * 페이지가 자동으로 새로 고침되도록 하려면 
  ...
  <script >
    ...
    function member_delete() {
      if (confirm("한번 삭제한 정보는 복구시킬 수 없습니다. 계속 진행하시겠습니까?")) {
