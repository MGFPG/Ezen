    ...
    for(int i=1; i<=end; i++) { //날짜출력
     out.println("<td>" + i + "<br>");
       ...
       try{
        ...
        String sql= "SELECT startdate, enddate FROM ProductionPlanning";
        ...
        while (rs.next()) { 
         ...
         if(year==year && month+1==month && i==day) {
          out.println(rs.getString("PPname")+"<br>"); 
         }
        }
        rs.close();
       }
