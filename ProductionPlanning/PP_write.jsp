...
<head>
  ...
  <script type="text/javascript" lang="ko">
    ...
    function check() {
      ...
      var f = document.New; 
      var n = parseFloat(document.getElementById('PP').value);
...
<body>
  ...
  <div style="position: relative; left: 50px; float: left;">
    ...
    <form method="post" action="PP_write_process.jsp" onsubmit="return check();" >
      <h2>공정계획 신규 등록 </h2>
      <fieldset>
        <table> 
          <br>  
          <label for="PPname" >*공정계획명 : </label>
            <input type="text" name="PPname" placeholder="공정계획명을 입력하세요" maxlength='20' size='20' style='background-color:#FFE2D5;'>

        <br><br>
        <label for="PPetc" >*설명 : </label> <br>
          <textarea rows="5" class="form-control" name="PPetc" onkeyup="fn_checkByte(this)" style='background-color:#FFE2D5;'></textarea >
